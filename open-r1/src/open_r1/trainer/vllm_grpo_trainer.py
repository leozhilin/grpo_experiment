...
class Qwen2VLGRPOVLLMTrainer(Trainer):
    ...
    def _prepare_inputs(
        ...
        pixel_values = pixel_values.unsqueeze(1).repeat_interleave(self.num_generations, dim=1)
        pixel_values = pixel_values.view(-1, *pixel_values.shape[2:])

        image_grid_thw = prompt_inputs["image_grid_thw"]
        image_grid_thw = image_grid_thw.unsqueeze(1).repeat_interleave(self.num_generations, dim=1)
        image_grid_thw = image_grid_thw.view(-1, *image_grid_thw.shape[2:])
